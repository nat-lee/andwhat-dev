...
<div class="subscribe-form">
    <div class="inner">
        ...
        <form class="epm-sign-up-form" name="epm-sign-up-form" action="#" method="post">
            ...
            <div class="epm-form-field">
                <input type="email" placeholder="<?php _e('Enter email address','easy-peasy-mailchimp');?>" name="epm-email" tabindex="8" class="email" id="epm-email" value=""/>
            </div>

            <input type="hidden" name="epm_submit" id="epm_submit" value="true" />
            <input type="hidden" name="epm_list_id" id="epm_list_id" value="<?php echo $list;?>" />

            <input type="submit" name="epm-submit-chimp" value="<?php _e('Join','easy-peasy-mailchimp');?>" data-wait-text="<?php _e('Please wait...','easy-peasy-mailchimp');?>" tabindex="10" class="button btn epm-sign-up-button epm-submit-chimp"/>
        </form>
    </div>
</div>